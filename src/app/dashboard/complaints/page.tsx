...
import FilterTabs from "@/components/dashboard/management/FilterTabs";
...
export default function ComplaintsPage() {
  ...
  return (
    <div className="mx-auto grid w-full max-w-[1440px] grid-cols-1 gap-6 p-1 md:grid-cols-12">
      ...
      {/* Header Row — matches Overview layout */}
      <div className="md:col-span-12 mb-2 flex items-start justify-between gap-4">
        <Reveal delay="0s">
        ...
        <Reveal delay="100ms" className="flex items-center gap-3 flex-shrink-0">
      ...
      {/* Full-width table — matches 12-col span used in Overview */}
