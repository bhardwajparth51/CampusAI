      ...
      <div className="relative h-[1.12em] overflow-hidden flex items-center justify-center">
        <AnimatePresence mode="wait">
          <motion.span
            ...
            className="absolute bg-gradient-to-r from-[#0062FF] via-blue-400 to-cyan-400 bg-clip-text text-transparent sm:whitespace-nowrap inline-flex items-center justify-center leading-none font-normal"
          >
            {CYCLING_WORDS[index]}
          </motion.span>
        </AnimatePresence>
