...
export const StatsBar = () => {
  return (
    <div className="w-full relative py-8 flex justify-center overflow-hidden">
      ...
      <Reveal delay="0.2s">
        <div className="max-w-5xl mx-auto flex flex-wrap items-center justify-center gap-4 md:gap-12 px-6 text-sm md:text-base font-mono font-medium tracking-tight text-white/50 lowercase italic">
